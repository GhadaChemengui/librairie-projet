                ...
                <div class="max-w-2xl mx-auto">
                            ...
                            <div class="form-group mb-8">
                                ...
                                <div class="mt-3 p-4 bg-blue-50 rounded-lg">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            <p class="text-sm text-blue-700 font-medium">Information sur les rôles :</p>
                                            <ul class="text-sm text-blue-600 mt-1 list-disc list-inside">
                                                <li><strong>Utilisateur :</strong> Peut acheter et consulter des livres</li>
                    ...
                    <div class="card p-6 mt-6 bg-blue-50 border-blue-200">
                        <div class="flex items-start">
                            ...
                            <div>
                                <h3 class="font-semibold text-blue-800 mb-2">Conseil de création</h3>
                                <p class="text-blue-700 text-sm">
                                    Assurez-vous que l'adresse email est valide et unique. Le mot de passe doit contenir au moins 8 caractères.
                                    Les utilisateurs recevront un email de confirmation si vous avez configuré l'envoi d'emails.
                                </p>
                            </div>
                        </div>
                    </div>
